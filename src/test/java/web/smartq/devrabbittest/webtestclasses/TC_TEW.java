package web.smartq.devrabbittest.webtestclasses;
...
import web.smartq.devrabbittest.webpageclasses.HomeScreen;
...
public class TC_TEW extends BaseClass {
	...
	public TC_TEW() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_TEW.class);
		configFileObj = new ConfigFilesUtility();
		configFileObj.loadPropertyFile("tc_tew.properties");
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath, HomeScreen.projectName);
		test = reports.startTest("TC_TEW");
	}
	...
	public void HomeScreenTest(int i) throws Exception {
	 ...
	 try{
		...
		objHomeScreen.clkAContact_301773();
